...
GO
		...
		BEGIN
			...
			FROM USUARIOS
			WHERE Mail_US = @MAIL AND Contraseña_US = @Password AND Estado_US = 1;
...
/*Triggers*/
		...
		--Trigger para poner en falso los estados de los artículos tras eliminar (dar baja lógica) una CATEGORÍA
		...
		--Trigger para poner en falso los estados de los artículos tras eliminar (dar baja lógica) un TIPO DE PRENDA
...
--Trigger para poner en false los artículos que se queden sin stock
